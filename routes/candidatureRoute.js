...
candidatureRoute.get("/all",protectRecruteur, getAllcandidatures).post("/add/:idOffre",protectRecruteur, postCandidature).put('/:id',protectRecruteur,modifierCandidature)
